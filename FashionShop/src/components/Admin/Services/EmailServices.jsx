export const sendOrderEmail = async (
  ...
  const response = await fetch(
    "https://fashionbackendfork.up.railway.app/api/send-orderEmail",
    {
      method: "POST",
...
export const sendWhatsappMessage = async (
  ...
  try {
    const response = await fetch(
      "https://fashionbackendfork.up.railway.app/api/send-whatsappMessage",
      {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
    ...
    return {
      success: false,
      message: "Error sending order confirmation message",
    };
  }
};
