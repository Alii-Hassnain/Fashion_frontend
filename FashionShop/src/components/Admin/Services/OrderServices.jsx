...
export const getAllOrders = async () => {
  ...
  export const updateOrder = async (orderId, updatedData) => {
    try {
      const response = await axios.put(`${BASE_URL}/update-Order/${orderId}`, updatedData);
      console.log("updatedorder response from backend in order servces : ",response.data.orders);
