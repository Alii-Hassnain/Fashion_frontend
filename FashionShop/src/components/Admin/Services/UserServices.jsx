...
const BASE_URL = "https://fashionbackendfork.up.railway.app/user";
...
export const getAllUsers = async () => {
  try {
    const response = await fetch(
      "https://fashionbackendfork.up.railway.app/admin/get-users",
      {
        method: "GET",
        credentials: "include",
      }
...
export const getAllUsersOrderSummary = async () => {
  try {
    const response = await fetch(
      "https://fashionbackendfork.up.railway.app/admin/getAllUsersOrderSummary",
      {
        method: "GET",
        credentials: "include",
      }
...
export const deleteUserById = async (userId) => {
  try {
    const response = await fetch(
      `https://fashionbackendfork.up.railway.app/admin/delete-user/${userId}`,
      {
        method: "DELETE",
        credentials: "include",
      }
