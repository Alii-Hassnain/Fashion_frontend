...
export const createReview = async (reviewData) => {
  ...
  try {
    const response = await fetch(
      "https://fashionbackendfork.up.railway.app/api/create-review",
      {
        method: "POST",
    ...
    console.log(
      "data from backend for creating review  in review services : ",
      data
    );
    if (data.success) {
...
export const getReviews = async (productId) => {
  try {
    const response = await fetch(
      `https://fashionbackendfork.up.railway.app/api/get-review/${productId}`,
      {
        method: "GET",
        credentials: "include",
      }
    ...
    const data = await response.json();
    console.log(
      "data from backend for getting reviews in review services : ",
      data
    );
    if (data.success) {
      return data;
...
export const deleteReview = async (reviewId) => {
  ...
  try {
    const response = await fetch(
      `https://fashionbackendfork.up.railway.app/api/delete-review/${reviewId}`,
      {
        method: "DELETE",
        credentials: "include",
      }
    ...
    const data = await response.json();
    console.log(
      "data from backend for deleting review in review services : ",
      data
    );
    if (data.success) {
...
export const getReviewsByUser = async (userId) => {
  ...
  try {
    const response = await fetch(
      `https://fashionbackendfork.up.railway.app/api/get-userReviews/${userId}`,
      {
        method: "GET",
        credentials: "include",
      }
    ...
    const data = await response.json();
    console.log(
      "data from backend for getting reviews by user in review services : ",
      data
    );
    if (data.success) {
      return data;
...
export const getReviewByUserEmailOrUsername = async (emailOrUsername) => {
  console.log(
    "emailOrUsername in getReviewByUserEmailOrUsername in review services : ",
    emailOrUsername
  );
  try {
    const response = await fetch(
      `https://fashionbackendfork.up.railway.app/api/review-byNameEmail/${emailOrUsername}`,
      {
        method: "GET",
        credentials: "include",
      }
    ...
    const data = await response.json();
    console.log(
      "data from backend for getting review by user email or username in review services : ",
      data
    );
    if (data.success) {
      return data;
...
export const getReviewByProductId = async (productId) => {
  console.log(
    "productId in getReviewByProductId in review services : ",
    productId
  );
  try {
    const response = await fetch(
      `https://fashionbackendfork.up.railway.app/api/review-byProductId/${productId}`,
      {
        method: "GET",
        credentials: "include",
      }
    ...
    const data = await response.json();
    console.log(
      "data from backend for getting review by product id in review services : ",
      data
    );
    if (data.success) {
      return data;
