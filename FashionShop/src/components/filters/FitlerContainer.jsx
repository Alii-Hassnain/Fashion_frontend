...
const FiltersContainer = ({ onGenderChange, onCategoryChange, onColorChange, onPriceChange, onSortChange ,applyFilters, filters,removeFilters ,isFilterApplied}) => {
  useEffect(()=>{
    ...
    <div className="w-64 p-4 bg-base-100 shadow-lg rounded-xl">
      ...
      <div className="text-center my-2">
          ...
          className={`text-white px-4 py-2 rounded-md transition-transform duration-300 transform scale-100 hover:scale-95 ${
            isFilterApplied ? "bg-red-500 hover:bg-red-700" : "bg-blue-500 hover:bg-blue-700"
          }`}
        >
